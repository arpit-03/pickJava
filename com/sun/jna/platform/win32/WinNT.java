...
/*      */   
/*  261 */   public static class LUID_AND_ATTRIBUTES extends Structure { public static final List<String> FIELDS = createFieldsOrder(new String[] { "Luid", "Attributes" });
/*      */ 
/*      */ 
/*      */     
...
/*      */     extends Structure
/*      */   {
/*  294 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Sid", "Attributes" });
/*      */ 
/*      */ 
/*      */     
...
/*      */     extends Structure
/*      */   {
/*  325 */     public static final List<String> FIELDS = createFieldsOrder("Owner");
/*      */ 
/*      */ 
/*      */     
...
/*  338 */       super((Pointer)new Memory(size));
/*      */     }
/*      */     
...
/*      */     
/*  354 */     public static final List<String> FIELDS = createFieldsOrder("sid");
/*      */     
/*      */     public Pointer sid;
/*      */ 
/*      */     
...
/*  362 */       super((Pointer)new Memory(data.length));
/*  363 */       getPointer().write(0L, data, 0, data.length);
/*  364 */       read();
/*      */     }
/*      */     
/*      */     public PSID(int size) {
/*  368 */       super((Pointer)new Memory(size));
/*      */     }
/*      */     
...
/*  377 */       int len = Advapi32.INSTANCE.GetLengthSid(this);
/*  378 */       return getPointer().getByteArray(0L, len);
/*      */     }
/*      */     
/*      */     public String getSidString() {
/*  382 */       return Advapi32Util.convertSidToStringSid(this);
/*      */     }
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/*  397 */       super(Pointer.SIZE);
/*  398 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.PSID h) {
/*  402 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.PSID getValue() {
/*  406 */       Pointer p = getPointer().getPointer(0L);
/*  407 */       if (p == null) {
/*  408 */         return null;
/*      */       }
/*      */       
/*  411 */       return new WinNT.PSID(p);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/*  421 */     public static final List<String> FIELDS = createFieldsOrder("User");
/*      */ 
/*      */ 
/*      */     
...
/*  439 */       super((Pointer)new Memory(size));
/*      */     }
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/*      */     extends Structure
/*      */   {
/*  453 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "GroupCount", "Group0" });
/*      */ 
/*      */     
...
/*  470 */       super((Pointer)new Memory(size));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  479 */       return (WinNT.SID_AND_ATTRIBUTES[])this.Group0.toArray(this.GroupCount);
/*      */     }
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  483 */       return FIELDS;
...
/*      */     extends Structure
/*      */   {
/*  492 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "PrivilegeCount", "Control", "Privileges" });
...
/*  505 */       this.PrivilegeCount = new WinDef.DWORD(nbOfPrivileges);
/*  506 */       if (nbOfPrivileges > 0) {
/*  507 */         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[nbOfPrivileges];
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/*  515 */       super(p);
/*  516 */       int count = p.getInt(0L);
/*  517 */       this.PrivilegeCount = new WinDef.DWORD(count);
/*  518 */       if (count > 0) {
/*  519 */         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[count];
/*      */       }
/*  521 */       read();
/*      */     }
/*      */ 
...
/*      */     extends Structure
/*      */   {
/*  535 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "PrivilegeCount", "Privileges" });
/*      */ 
/*      */ 
/*      */     
/*      */     public WinDef.DWORD PrivilegeCount;
...
/*  556 */       this.PrivilegeCount = new WinDef.DWORD(nbOfPrivileges);
/*  557 */       this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[nbOfPrivileges];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  564 */       super(p);
/*  565 */       int count = p.getInt(0L);
/*  566 */       this.PrivilegeCount = new WinDef.DWORD(count);
/*  567 */       this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[count];
/*  568 */       read();
/*      */     }
/*      */ 
/*      */     
...
/*      */     extends Structure
/*      */   {
/*  886 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "NextEntryOffset", "Action", "FileNameLength", "FileName" });
/*      */     
...
/*  900 */             size() + ", requested " + size);
/*      */       }
/*  902 */       allocateMemory(size);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public void read() {
/*  922 */       this.FileName = new char[0];
/*  923 */       super.read();
/*  924 */       this.FileName = getPointer().getCharArray(12L, this.FileNameLength / 2);
/*      */     }
/*      */     
/*      */     public FILE_NOTIFY_INFORMATION next() {
/*  928 */       if (this.NextEntryOffset == 0) {
/*  929 */         return null;
/*      */       }
/*  931 */       FILE_NOTIFY_INFORMATION next = new FILE_NOTIFY_INFORMATION();
/*  932 */       next.useMemory(getPointer(), this.NextEntryOffset);
/*  933 */       next.read();
/*  934 */       return next;
/*      */     }
/*      */   }
...
/*      */     extends Structure
/*      */   {
/* 1171 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "LowPart", "HighPart" });
/*      */     
/*      */     public int LowPart;
/*      */     public int HighPart;
/*      */     
...
/*      */       extends LARGE_INTEGER implements Structure.ByReference {}
/*      */     
/*      */     public static class LowHigh extends Structure {
/* 1190 */       public static final List<String> FIELDS = createFieldsOrder(new String[] { "LowPart", "HighPart" });
/*      */       
...
/* 1199 */         this(new WinDef.DWORD(value & 0xFFFFFFFFL), new WinDef.DWORD(value >> 32L & 0xFFFFFFFFL));
/*      */       }
/*      */       
/*      */       public LowHigh(WinDef.DWORD low, WinDef.DWORD high) {
/* 1203 */         this.LowPart = low;
/* 1204 */         this.HighPart = high;
/*      */       }
/*      */ 
/*      */       
/*      */       protected List<String> getFieldOrder() {
...
/* 1213 */         long loValue = this.LowPart.longValue();
/* 1214 */         long hiValue = this.HighPart.longValue();
/* 1215 */         return hiValue << 32L & 0xFFFFFFFF00000000L | loValue & 0xFFFFFFFFL;
/*      */       }
/*      */ 
/*      */       
/*      */       public String toString() {
/* 1220 */         if (this.LowPart == null || this.HighPart == null) {
/* 1221 */           return "null";
/*      */         }
/* 1223 */         return Long.toString(longValue());
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/* 1238 */         this.lh = new WinNT.LARGE_INTEGER.LowHigh(value);
/*      */       }
/*      */       
/*      */       public long longValue() {
...
/*      */       
/*      */       public String toString() {
/* 1247 */         return Long.toString(longValue());
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1255 */       return Collections.singletonList("u");
/*      */     }
/*      */ 
/*      */     
...
/* 1281 */       return this.u.lh.HighPart;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1290 */       return this.u.value;
/*      */     }
/*      */ 
/*      */     
/*      */     public int compareTo(LARGE_INTEGER other) {
/* 1295 */       return compare(this, other);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1300 */       return (this.u == null) ? "null" : Long.toString(getValue());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1322 */         return -1;
/*      */       }
/* 1324 */       return IntegerType.compare(v1.getValue(), v2.getValue());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1341 */         return 1;
/*      */       }
/* 1343 */       return IntegerType.compare(v1.getValue(), v2);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1358 */       setPointer(p);
/* 1359 */       this.immutable = true;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/* 1365 */       Object o = super.fromNative(nativeValue, context);
/* 1366 */       if (WinBase.INVALID_HANDLE_VALUE.equals(o)) {
/* 1367 */         return WinBase.INVALID_HANDLE_VALUE;
/*      */       }
/* 1369 */       return o;
/*      */     }
/*      */ 
...
/* 1374 */       if (this.immutable) {
/* 1375 */         throw new UnsupportedOperationException("immutable reference");
/*      */       }
/*      */       
/* 1378 */       super.setPointer(p);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1383 */       return String.valueOf(getPointer());
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1396 */       super(Pointer.SIZE);
/* 1397 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.HANDLE h) {
/* 1401 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.HANDLE getValue() {
/* 1405 */       Pointer p = getPointer().getPointer(0L);
/* 1406 */       if (p == null) {
/* 1407 */         return null;
/*      */       }
/* 1409 */       if (WinBase.INVALID_HANDLE_VALUE.getPointer().equals(p)) {
/* 1410 */         return WinBase.INVALID_HANDLE_VALUE;
/*      */       }
/* 1412 */       WinNT.HANDLE h = new WinNT.HANDLE();
/* 1413 */       h.setPointer(p);
/* 1414 */       return h;
/*      */     }
/*      */   }
...
/*      */     extends Structure
/*      */   {
/* 1865 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion", "dwBuildNumber", "dwPlatformId", "szCSDVersion" });
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/* 1901 */       this.szCSDVersion = new char[128];
/* 1902 */       this.dwOSVersionInfoSize = new WinDef.DWORD(size());
/*      */     }
/*      */     
...
/*      */     extends Structure
/*      */   {
/* 1923 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "dwOSVersionInfoSize", "dwMajorVersion", "dwMinorVersion", "dwBuildNumber", "dwPlatformId", "szCSDVersion", "wServicePackMajor", "wServicePackMinor", "wSuiteMask", "wProductType", "wReserved" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 1995 */       this.szCSDVersion = new char[128];
/* 1996 */       this.dwOSVersionInfoSize = new WinDef.DWORD(size());
/*      */     }
/*      */     
...
/*      */     
/*      */     public int getMajor() {
/* 2013 */       return this.dwMajorVersion.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public int getMinor() {
/* 2020 */       return this.dwMinorVersion.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2027 */       return this.dwBuildNumber.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2034 */       return this.dwPlatformId.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2043 */       return Native.toString(this.szCSDVersion);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2050 */       return this.wSuiteMask.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/* 2149 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Length", "Reserved", "RecordNumber", "TimeGenerated", "TimeWritten", "EventID", "EventType", "NumStrings", "EventCategory", "ReservedFlags", "ClosingRecordNumber", "StringOffset", "UserSidLength", "UserSidOffset", "DataLength", "DataOffset" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 2499 */     public static final List<String> FIELDS = createFieldsOrder("data");
/*      */     
/*      */     public byte[] data;
/*      */ 
/*      */     
...
/* 2508 */       this.data = data;
/* 2509 */       useMemory((Pointer)new Memory(data.length));
/*      */     }
/*      */ 
/*      */     
/*      */     public SECURITY_DESCRIPTOR(int size) {
/* 2514 */       useMemory((Pointer)new Memory(size));
/* 2515 */       this.data = new byte[size];
/*      */     }
/*      */     
...
/*      */     extends Structure
/*      */   {
/* 2542 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "AclRevision", "Sbz1", "AclSize", "AceCount", "Sbz2" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2548 */     public static int MAX_ACL_SIZE = 65536;
/*      */     
...
/*      */     
/*      */     public ACL(int size) {
/* 2564 */       useMemory((Pointer)new Memory(size));
/*      */     }
/*      */     
/*      */     public ACL(Pointer pointer) {
/* 2568 */       super(pointer);
/* 2569 */       read();
/* 2570 */       this.ACEs = new WinNT.ACCESS_ACEStructure[this.AceCount];
/* 2571 */       int offset = size();
/* 2572 */       for (int i = 0; i < this.AceCount; i++) {
/* 2573 */         WinNT.ACCESS_ACEStructure ace; Pointer share = pointer.share(offset);
/*      */         
/* 2575 */         byte aceType = share.getByte(0L);
/*      */         
/* 2577 */         switch (aceType) {
/*      */           case 0:
/* 2579 */             ace = new WinNT.ACCESS_ALLOWED_ACE(share);
/*      */             break;
/*      */           case 1:
/* 2582 */             ace = new WinNT.ACCESS_DENIED_ACE(share);
/*      */             break;
/*      */           default:
/* 2585 */             throw new IllegalArgumentException("Unknown ACE type " + aceType);
/*      */         } 
/* 2587 */         this.ACEs[i] = ace;
/* 2588 */         offset += ace.AceSize;
/*      */       } 
/*      */     }
/*      */     
/*      */     public WinNT.ACCESS_ACEStructure[] getACEStructures() {
/* 2593 */       return this.ACEs;
/*      */     }
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/* 2608 */       super(Pointer.SIZE);
/* 2609 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.ACL h) {
/* 2613 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.ACL getValue() {
/* 2617 */       Pointer p = getPointer().getPointer(0L);
/* 2618 */       if (p == null) {
/* 2619 */         return null;
/*      */       }
/*      */       
/* 2622 */       return new WinNT.ACL(p);
/*      */     }
/*      */   }
/*      */   
...
/*      */       implements Structure.ByReference {}
/*      */     
/* 2632 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Revision", "Sbz1", "Control", "Owner", "Group", "Sacl", "Dacl" });
/*      */     
...
/* 2652 */       super((Pointer)new Memory(data.length));
/* 2653 */       getPointer().write(0L, data, 0, data.length);
/* 2654 */       setMembers();
/*      */     }
/*      */     
/*      */     public SECURITY_DESCRIPTOR_RELATIVE(int length) {
/* 2658 */       super((Pointer)new Memory(length));
/*      */     }
/*      */     
...
/* 2667 */       return this.OWNER;
/*      */     }
/*      */     
/*      */     public WinNT.PSID getGroup() {
/* 2671 */       return this.GROUP;
/*      */     }
/*      */     
/*      */     public WinNT.ACL getDiscretionaryACL() {
/* 2675 */       return this.DACL;
/*      */     }
/*      */     
/*      */     public WinNT.ACL getSystemACL() {
/* 2679 */       return this.SACL;
/*      */     }
/*      */     
/*      */     private final void setMembers() {
/* 2683 */       read();
/* 2684 */       if (this.Dacl != 0) {
/* 2685 */         this.DACL = new WinNT.ACL(getPointer().share(this.Dacl));
/*      */       }
/* 2687 */       if (this.Sacl != 0) {
/* 2688 */         this.SACL = new WinNT.ACL(getPointer().share(this.Sacl));
/*      */       }
/* 2690 */       if (this.Group != 0) {
/* 2691 */         this.GROUP = new WinNT.PSID(getPointer().share(this.Group));
/*      */       }
/* 2693 */       if (this.Owner != 0) {
/* 2694 */         this.OWNER = new WinNT.PSID(getPointer().share(this.Owner));
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/* 2705 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "AceType", "AceFlags", "AceSize" });
/*      */     
/*      */     public byte AceType;
/*      */     
...
/*      */ 
/*      */     
/*      */     public ACEStructure(byte AceType, byte AceFlags, short AceSize, WinNT.PSID psid) {
/* 2723 */       this.AceType = AceType;
/* 2724 */       this.AceFlags = AceFlags;
/* 2725 */       this.AceSize = AceSize;
/* 2726 */       this.psid = psid;
/* 2727 */       write();
/*      */     }
/*      */     
/*      */     public String getSidString() {
/* 2731 */       return Advapi32Util.convertSidToStringSid(this.psid);
/*      */     }
/*      */     
/*      */     public WinNT.PSID getSID() {
/* 2735 */       return this.psid;
/*      */     }
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/*      */     extends ACEStructure
/*      */   {
/* 2760 */     public static final List<String> FIELDS = createFieldsOrder(WinNT.ACEStructure.FIELDS, new String[] { "Mask", "SidStart" });
/*      */ 
/*      */ 
/*      */     
/*      */     public int Mask;
/*      */ 
/*      */     
/* 2767 */     public byte[] SidStart = new byte[4];
/*      */ 
/*      */ 
/*      */     
...
/* 2775 */       calculateSize(true);
/* 2776 */       this.AceType = AceType;
/* 2777 */       this.AceFlags = AceFlags;
/* 2778 */       this.AceSize = (short)(fieldOffset("SidStart") + (psid.getBytes()).length);
/* 2779 */       this.psid = psid;
/* 2780 */       this.Mask = Mask;
/* 2781 */       this.SidStart = psid.getPointer().getByteArray(0L, this.SidStart.length);
/* 2782 */       allocateMemory(this.AceSize);
/* 2783 */       write();
/*      */     }
/*      */     
...
/*      */     public void write() {
/* 2796 */       super.write();
/* 2797 */       int offsetOfSID = fieldOffset("SidStart");
/* 2798 */       int sizeOfSID = this.AceSize - fieldOffset("SidStart");
/* 2799 */       if (this.psid != null) {
/*      */         
/* 2801 */         byte[] psidWrite = this.psid.getBytes();
/* 2802 */         assert psidWrite.length <= sizeOfSID;
/*      */         
/* 2804 */         getPointer().write(offsetOfSID, psidWrite, 0, sizeOfSID);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void read() {
/* 2810 */       super.read();
/* 2811 */       int offsetOfSID = fieldOffset("SidStart");
/* 2812 */       int sizeOfSID = this.AceSize - fieldOffset("SidStart");
/* 2813 */       if (sizeOfSID > 0) {
/* 2814 */         this.psid = new WinNT.PSID(getPointer().getByteArray(offsetOfSID, sizeOfSID));
/*      */       } else {
/* 2816 */         this.psid = new WinNT.PSID();
/*      */       } 
/*      */     }
/*      */ 
/*      */     
...
/* 2837 */       super(Mask, (byte)0, AceFlags, psid);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 2852 */       super(Mask, (byte)1, AceFlags, psid);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 2898 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "genericRead", "genericWrite", "genericExecute", "genericAll" });
/*      */     
...
/*      */     extends Structure
/*      */   {
/* 2917 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "processorMask", "relationship", "payload" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 2983 */       public WinDef.ULONGLONG[] reserved = new WinDef.ULONGLONG[2];
/*      */     }
/*      */     
/*      */     public static class AnonymousStructProcessorCore extends Structure {
/* 2987 */       public static final List<String> FIELDS = createFieldsOrder("flags");
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 3005 */       public static final List<String> FIELDS = createFieldsOrder("nodeNumber");
/*      */ 
/*      */ 
/*      */       
...
/*      */     extends Structure
/*      */   {
/* 3071 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "level", "associativity", "lineSize", "size", "type" });
/*      */ 
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 3114 */     public static int CacheUnified = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3119 */     public static int CacheInstruction = 1;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3124 */     public static int CacheData = 2;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3129 */     public static int CacheTrace = 3;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/* 3165 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "baseAddress", "allocationBase", "allocationProtect", "regionSize", "state", "protect", "type" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     extends Structure {
/* 3224 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Length", "ImpersonationLevel", "ContextTrackingMode", "EffectiveOnly" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/* 3536 */       return new WinDef.LCID(_MAKELCID(lgid, srtid));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 3548 */       return new WinDef.LCID((_MAKELCID(lgid, srtid) | ver << 20));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 3558 */       return lcid.intValue() & 0xFFFF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 3568 */       return lcid.intValue() >>> 16 & 0xF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 3578 */       return lcid.intValue() >>> 20 & 0xF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 3609 */       return (lgid & 0xFFFF) >>> 10;
/*      */     }
/*      */   }
/*      */   
/* 3613 */   public static final int LANG_SYSTEM_DEFAULT = LocaleMacros.MAKELANGID(0, 2);
/* 3614 */   public static final int LANG_USER_DEFAULT = LocaleMacros.MAKELANGID(0, 1);
/*      */   
/* 3616 */   public static final WinDef.LCID LOCALE_SYSTEM_DEFAULT = LocaleMacros.MAKELCID(LANG_SYSTEM_DEFAULT, 0);
/* 3617 */   public static final WinDef.LCID LOCALE_USER_DEFAULT = LocaleMacros.MAKELCID(LANG_USER_DEFAULT, 0);
/*      */   
/* 3619 */   public static final WinDef.LCID LOCALE_NEUTRAL = LocaleMacros.MAKELCID(LocaleMacros.MAKELANGID(0, 0), 0);
/*      */   
/* 3621 */   public static final WinDef.LCID LOCALE_INVARIANT = LocaleMacros.MAKELCID(LocaleMacros.MAKELANGID(127, 0), 0); }


/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/com/sun/jna/platform/win32/WinNT.class
