...
/*  56 */         super(guid.getPointer());
/*     */         
/*  58 */         this.Data1 = guid.Data1;
/*  59 */         this.Data2 = guid.Data2;
/*  60 */         this.Data3 = guid.Data3;
/*  61 */         this.Data4 = guid.Data4;
/*     */       }
...
/*  89 */         super(guid.getPointer());
/*     */         
/*  91 */         this.Data1 = guid.Data1;
/*  92 */         this.Data2 = guid.Data2;
/*  93 */         this.Data3 = guid.Data3;
/*  94 */         this.Data4 = guid.Data4;
/*     */       }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     }
/*     */     
/* 108 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Data1", "Data2", "Data3", "Data4" });
/*     */ 
/*     */     
/*     */     public int Data1;
/*     */ 
...
/* 516 */       super(guid.getPointer());
/*     */     }
/*     */     
/*     */     public void setValue(Guid.IID value) {
/* 520 */       setPointer(value.getPointer());
/*     */     }
/*     */     
/*     */     public Guid.IID getValue() {
/* 524 */       return new Guid.IID(getPointer());
/*     */     }
/*     */ 
/*     */     
/*     */     public boolean equals(Object o) {
...
/* 533 */         return true;
/*     */       }
/* 535 */       if (getClass() != o.getClass()) {
/* 536 */         return false;
/*     */       }
/*     */       
/* 539 */       REFIID other = (REFIID)o;
/* 540 */       return getValue().equals(other.getValue());
/*     */     }
/*     */ 
/*     */     
/*     */     public int hashCode() {
/* 545 */       return getValue().hashCode();
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 593 */       this(guid.toGuidString());
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/com/sun/jna/platform/win32/Guid.class
