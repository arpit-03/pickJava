...
/*     */ {
/*  50 */   public static final Winspool INSTANCE = (Winspool)Native.loadLibrary("Winspool.drv", Winspool.class, W32APIOptions.DEFAULT_OPTIONS);
/*     */   
...
/*     */     extends Structure
/*     */   {
/* 270 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "Flags", "pDescription", "pName", "pComment" });
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/* 298 */       super((Pointer)new Memory(size));
/*     */     }
/*     */ 
/*     */     
...
/* 441 */       super((Pointer)new Memory(size));
/*     */     }
/*     */ 
/*     */     
/*     */     protected List<String> getFieldOrder() {
...
/* 453 */       return ((this.Attributes & value) == value);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/*     */     extends Structure
/*     */   {
/* 471 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "pPrinterName", "pServerName", "Attributes" });
/*     */ 
/*     */ 
/*     */     
/*     */     public String pPrinterName;
...
/* 492 */       super((Pointer)new Memory(size));
/*     */     }
/*     */ 
/*     */     
/*     */     protected List<String> getFieldOrder() {
...
/*     */     extends Structure
/*     */   {
/* 509 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "pDatatype", "pDevMode", "DesiredAccess" });
/*     */ 
/*     */ 
/*     */ 
/*     */     
...
/*     */     extends Structure
/*     */   {
/* 816 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "JobId", "pPrinterName", "pMachineName", "pUserName", "pDocument", "pDatatype", "pStatus", "Status", "Priority", "Position", "TotalPages", "PagesPrinted", "Submitted" });
/*     */ 
/*     */ 
/*     */ 
/*     */ 
...
/* 900 */       super((Pointer)new Memory(size));
/*     */     }
/*     */ 
/*     */     
/*     */     protected List<String> getFieldOrder() {
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/com/sun/jna/platform/win32/Winspool.class
