...
/*   98 */       return Arrays.asList(new String[] { "cbSize", "flags", "hwndActive", "hwndFocus", "hwndCapture", "hwndMenuOwner", "hwndMoveSize", "hwndCaret", "rcCaret" });
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  118 */       return Arrays.asList(new String[] { "cbSize", "rcWindow", "rcClient", "dwStyle", "dwExStyle", "dwWindowStatus", "cxWindowBorders", "cyWindowBorders", "atomWindowType", "wCreatorVersion" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  187 */       return Arrays.asList(new String[] { "length", "flags", "showCmd", "ptMinPosition", "ptMaxPosition", "rcNormalPosition" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */   
/*      */   public static class MSG extends Structure { public WinDef.HWND hWnd;
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  348 */       return Arrays.asList(new String[] { "hWnd", "message", "wParam", "lParam", "time", "pt" });
/*      */     }
/*      */     
/*      */     public int message;
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  374 */       return Arrays.asList(new String[] { "dwData", "cbData", "lpData" });
/*      */     } }
/*      */ 
/*      */   
/*      */   public static class FLASHWINFO extends Structure {
/*  379 */     public int cbSize = size();
/*      */     
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  387 */       return Arrays.asList(new String[] { "cbSize", "hWnd", "dwFlags", "uCount", "dwTimeout" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  471 */       return Arrays.asList(new String[] { "cx", "cy" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/*  481 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "BlendOp", "BlendFlags", "SourceConstantAlpha", "AlphaFormat" });
/*      */     
/*  483 */     public byte BlendOp = 0;
/*  484 */     public byte BlendFlags = 0;
/*      */     
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  541 */       return Arrays.asList(new String[] { "lParam", "wParam", "message", "hwnd" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/*  664 */       return Arrays.asList(new String[] { "vkCode", "scanCode", "flags", "time", "dwExtraInfo" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1108 */       return Arrays.asList(new String[] { "uMsg", "wParamL", "wParamH" });
/*      */     }
/*      */   }
/*      */   
...
/*      */ 
/*      */     
/* 1141 */     public INPUT_UNION input = new INPUT_UNION();
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1145 */       return Arrays.asList(new String[] { "type", "input" });
/*      */     }
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1244 */       return Arrays.asList(new String[] { "wVk", "wScan", "dwFlags", "time", "dwExtraInfo" });
/*      */     }
/*      */   }
/*      */   
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1281 */       return Arrays.asList(new String[] { "dx", "dy", "mouseData", "dwFlags", "time", "dwExtraInfo" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1297 */       return Arrays.asList(new String[] { "cbSize", "dwTime" });
/*      */     }
/*      */   }
/*      */   
...
/*      */     public WNDCLASSEX()
/*      */     {
/* 1323 */       super(W32APITypeMapper.DEFAULT);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 1338 */       this.cbSize = size(); } public WNDCLASSEX(Pointer memory) { super(memory, 0, W32APITypeMapper.DEFAULT); this.cbSize = size();
/*      */       read(); }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     protected List<String> getFieldOrder() {
/* 1375 */       return Arrays.asList(new String[] { "cbSize", "style", "lpfnWndProc", "cbClsExtra", "cbWndExtra", "hInstance", "hIcon", "hCursor", "hbrBackground", "lpszMenuName", "lpszClassName", "hIconSm" });
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/* 1478 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "cbSize", "rcMonitor", "rcWork", "dwFlags" });
/*      */ 
/*      */ 
/*      */     
/* 1482 */     public int cbSize = size();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     extends Structure
/*      */   {
/* 1521 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "cbSize", "rcMonitor", "rcWork", "dwFlags", "szDevice" });
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 1558 */     public char[] szDevice = new char[32];
/* 1559 */     public int cbSize = size(); public WinDef.RECT rcMonitor;
/*      */     public WinDef.RECT rcWork;
/*      */     public int dwFlags;
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/*      */     extends Structure
/*      */   {
/* 1896 */     public static final List<String> FIELDS = createFieldsOrder(new String[] { "hDevice", "dwType" });
/*      */     
...
/*      */     
/*      */     public int sizeof() {
/* 1909 */       return calculateSize(false);
/*      */     }
/*      */ 
/*      */     
/*      */     protected List<String> getFieldOrder() {
...
/* 1919 */       return "hDevice=" + this.hDevice + ", dwType=" + this.dwType;
/*      */     }
/*      */   }
/*      */ }


/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/com/sun/jna/platform/win32/WinUser.class
