...
/*      */     
/*  192 */     if (!isCompatibleVersion("5.2.2", getNativeVersion())) {
/*  193 */       String LS = System.getProperty("line.separator");
/*  194 */       throw new Error(LS + LS + "There is an incompatible JNA native library installed on this system" + LS + "Expected: " + "5.2.2" + LS + "Found:    " + 
/*      */ 
/*      */           
...
/* 1887 */     String DEFAULT_VERSION = "4.5.2";
/* 1888 */     String DEFAULT_BUILD = "4.5.2 (package information missing)";
...
/*      */     
/* 1894 */     String version = (pkg != null) ? pkg.getSpecificationVersion() : "4.5.2";
/* 1895 */     if (version == null) version = "4.5.2"; 
/* 1896 */     title = title + " API Version " + version;
/* 1897 */     System.out.println(title);
/*      */     
/* 1899 */     version = (pkg != null) ? pkg.getImplementationVersion() : "4.5.2 (package information missing)";
/* 1900 */     if (version == null) version = "4.5.2 (package information missing)"; 
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/com/sun/jna/Native.class
