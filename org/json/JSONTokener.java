...
/*  66 */     this
/*     */       
/*  68 */       .reader = reader.markSupported() ? reader : new BufferedReader(reader);
/*  69 */     this.eof = false;
...
/* 246 */     if (n != c) {
/* 247 */       if (n > '\000') {
/* 248 */         throw syntaxError("Expected '" + c + "' and instead saw '" + n + "'");
/*     */       }
/*     */       
...
/*     */     while (true) {
/* 401 */       char c = next();
/* 402 */       if (delimiters.indexOf(c) >= 0 || c == '\000' || c == '\n' || c == '\r') {
/*     */         
/* 404 */         if (c != '\000') {
/* 405 */           back();
/*     */         }
...
/* 507 */     return new JSONException(message + toString());
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 518 */     return new JSONException(message + toString(), causedBy);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 528 */     return " at " + this.index + " [character " + this.character + " line " + this.line + "]";
/*     */   }
/*     */ }


/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/json/JSONTokener.class
