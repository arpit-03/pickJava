...
/*     */ 
/*     */       
/* 282 */       .mode = (this.top == 0) ? 'd' : ((this.stack[this.top - 1] == null) ? 'a' : 'k');
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/*     */     } 
/* 350 */     if (value instanceof Boolean || value instanceof JSONObject || value instanceof JSONArray)
/*     */     {
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/json/JSONWriter.class
