...
/* 107 */       char c = x.next();
/* 108 */       if (value == null || (ja
/* 109 */         .length() == 0 && value.length() == 0 && c != ',')) {
/* 110 */         return null;
/*     */       }
/* 112 */       ja.put(value);
/*     */       
...
/* 119 */             return ja;
/*     */           }
/* 121 */           throw x.syntaxError("Bad character '" + c + "' (" + c + ").");
/*     */         } 
/*     */         
/* 124 */         c = x.next();
/*     */       } 
...
/* 161 */         if (string.length() > 0 && (string.indexOf(',') >= 0 || string
/* 162 */           .indexOf('\n') >= 0 || string.indexOf('\r') >= 0 || string
/* 163 */           .indexOf(false) >= 0 || string.charAt(0) == '"')) {
/* 164 */           sb.append('"');
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/json/CDL.class
