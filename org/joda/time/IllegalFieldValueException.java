...
/*  41 */     StringBuilder stringBuilder = (new StringBuilder()).append("Value ").append(paramNumber1).append(" for ").append(paramString1).append(' ');
/*     */ 
/*     */     
/*  44 */     if (paramNumber2 == null) {
/*  45 */       if (paramNumber3 == null) {
/*  46 */         stringBuilder.append("is not supported");
/*     */       } else {
/*  48 */         stringBuilder.append("must not be larger than ").append(paramNumber3);
/*     */       } 
/*  50 */     } else if (paramNumber3 == null) {
/*  51 */       stringBuilder.append("must not be smaller than ").append(paramNumber2);
/*     */     } else {
/*  53 */       stringBuilder.append("must be in the range [").append(paramNumber2).append(',').append(paramNumber3).append(']');
/*     */     } 
/*     */ 
/*     */ 
/*     */ 
...
/*  60 */       stringBuilder.append(": ").append(paramString2);
/*     */     }
/*     */     
...
/*  74 */     StringBuffer stringBuffer = (new StringBuffer()).append("Value ");
/*     */     
/*  76 */     if (paramString2 == null) {
/*  77 */       stringBuffer.append("null");
/*     */     } else {
/*  79 */       stringBuffer.append('"');
/*  80 */       stringBuffer.append(paramString2);
/*  81 */       stringBuffer.append('"');
/*     */     } 
/*     */     
/*  84 */     stringBuffer.append(" for ").append(paramString1).append(' ').append("is not supported");
/*     */     
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/joda/time/IllegalFieldValueException.class
