...
/*  87 */     this._mask = mask;
/*  88 */     int count = 0;
/*  89 */     int bit_pattern = mask;
/*     */     
/*  91 */     if (bit_pattern != 0) {
/*  92 */       while ((bit_pattern & 0x1) == 0) {
/*  93 */         count++;
/*  94 */         bit_pattern >>= 1;
/*     */       } 
/*     */     }
/*  97 */     this._shift_count = count;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 115 */     return getRawValue(holder) >> this._shift_count;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 172 */     return ((holder & this._mask) != 0);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 188 */     return ((holder & this._mask) == this._mask);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 202 */     return holder & (this._mask ^ 0xFFFFFFFF) | value << this._shift_count & this._mask;
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 228 */     return holder & (this._mask ^ 0xFFFFFFFF);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/apache/commons/lang3/BitField.class
