...
/* 546 */       IOSession session = request.getSession();
/* 547 */       if (session != null) {
/* 548 */         session.close();
/*     */       }
/*     */       
...
/* 558 */       RouteSpecificPool<T, C, E> pool = getPool(route);
/* 559 */       IOSession session = request.getSession();
/*     */       try {
/* 561 */         C conn = this.connFactory.create(route, session);
/* 562 */         E entry = pool.createEntry(request, conn);
/* 563 */         if (pool.completed(request, entry)) {
/* 564 */           this.leased.add(entry);
/* 565 */           onLease(entry);
/*     */         } else {
/* 567 */           this.available.add(entry);
/* 568 */           if (this.ioReactor.getStatus().compareTo((Enum)IOReactorStatus.ACTIVE) <= 0) {
...
/* 591 */       RouteSpecificPool<T, C, E> pool = getPool(route);
/* 592 */       pool.cancelled(request);
/* 593 */       if (this.ioReactor.getStatus().compareTo((Enum)IOReactorStatus.ACTIVE) <= 0) {
...
/* 612 */       RouteSpecificPool<T, C, E> pool = getPool(route);
...
/* 631 */       RouteSpecificPool<T, C, E> pool = getPool(route);
...
/* 641 */     Integer v = this.maxPerRoute.get(route);
...
/* 715 */     this.lock.lock();
/*     */     try {
/* 717 */       return new PoolStats(this.leased.size(), this.pending.size(), this.available.size(), this.maxTotal);
/*     */     
/*     */     }
/*     */     finally {
/*     */ 
...
/* 730 */     this.lock.lock();
/*     */     try {
/* 732 */       RouteSpecificPool<T, C, E> pool = getPool(route);
/* 733 */       int pendingCount = 0;
/* 734 */       for (LeaseRequest<T, C, E> request : this.leasingRequests) {
/* 735 */         if (LangUtils.equals(route, request.getRoute())) {
/* 736 */           pendingCount++;
/*     */         }
/*     */       } 
/* 739 */       return new PoolStats(pool.getLeasedCount(), pendingCount + pool.getPendingCount(), pool.getAvailableCount(), getMax(route));
/*     */     
/*     */     }
/*     */     finally {
/*     */ 
...
/* 755 */     this.lock.lock();
/*     */     try {
/* 757 */       return new HashSet(this.routeToPool.keySet());
/*     */     } finally {
...
/* 769 */     this.lock.lock();
/*     */     try {
/* 771 */       Iterator<E> it = this.available.iterator();
/* 772 */       while (it.hasNext()) {
/* 773 */         PoolEntry poolEntry = (PoolEntry)it.next();
/* 774 */         callback.process(poolEntry);
/* 775 */         if (poolEntry.isClosed()) {
/* 776 */           RouteSpecificPool<T, C, E> pool = getPool((T)poolEntry.getRoute());
/* 777 */           pool.remove((E)poolEntry);
/* 778 */           it.remove();
/*     */         } 
/*     */       } 
...
/* 794 */     this.lock.lock();
/*     */     try {
/* 796 */       Iterator<E> it = this.leased.iterator();
/* 797 */       while (it.hasNext()) {
/* 798 */         PoolEntry poolEntry = (PoolEntry)it.next();
/* 799 */         callback.process(poolEntry);
/*     */       } 
...
/* 816 */       PoolEntry poolEntry = (PoolEntry)it.next();
/* 817 */       callback.process(poolEntry);
/*     */     } 
/* 819 */     processPendingRequests();
/*     */   }
/*     */   
/*     */   private void purgePoolMap() {
/* 823 */     Iterator<Map.Entry<T, RouteSpecificPool<T, C, E>>> it = this.routeToPool.entrySet().iterator();
/* 824 */     while (it.hasNext()) {
/* 825 */       Map.Entry<T, RouteSpecificPool<T, C, E>> entry = it.next();
/* 826 */       RouteSpecificPool<T, C, E> pool = entry.getValue();
...
/* 883 */       AbstractNIOConnPool.this.requestCompleted(request);
/*     */     }
/*     */ 
/*     */     
/*     */     public void cancelled(SessionRequest request) {
/* 888 */       AbstractNIOConnPool.this.requestCancelled(request);
/*     */     }
/*     */ 
/*     */     
/*     */     public void failed(SessionRequest request) {
/* 893 */       AbstractNIOConnPool.this.requestFailed(request);
/*     */     }
/*     */ 
/*     */     
/*     */     public void timeout(SessionRequest request) {
/* 898 */       AbstractNIOConnPool.this.requestTimeout(request);
/*     */     }
/*     */   }
/*     */ }


/* Location:              /home/arpit/Downloads/Picking-Tool-6.5.2.jar!/org/apache/http/nio/pool/AbstractNIOConnPool.class
